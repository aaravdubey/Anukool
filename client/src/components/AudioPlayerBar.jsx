const AudioPlayerBar = () => {
  return <div className="fixed bottom-0 left-0 z-50 grid w-full h-24 grid-cols-1 px-8 bg-white border-t border-gray-200 md:grid-cols-3 dark:bg-gray-700 dark:border-gray-600">
    <div className="items-center justify-center hidden me-auto md:flex">
      {/* <img className="h-8 me-3 rounded" src="/docs/images/misc/flowbite-yt-screenshot.png" alt="Video preview" /> */}
